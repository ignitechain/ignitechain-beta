...
// This file contains a miner stress test based on the yantra consensus engine.
package main
...
func main() {
	...
	// Create a Yantra network based off of the Rinkeby config
...
// makeGenesis creates a custom Yantra genesis block based on some pre-defined
...
func makeGenesis(faucets []*ecdsa.PrivateKey, sealers []*ecdsa.PrivateKey) *core.Genesis {
	...
	genesis.Config.Yantra.Period = 1
