...
func (s *PublicTransactionPoolAPI) GetTransactionReceipt(ctx context.Context, hash common.Hash) (map[string]interface{}, error) {
	...
	fields := map[string]interface{}{
		...
		"validatorReward":   receipt.ValidatorReward,
		"txnReward":         receipt.TxnReward,
		"systemReward":      receipt.SystemReward,
		"foundationReward":  receipt.FoundationReward,
		"developersReward":  receipt.DevelopersReward,
		"delegatorReward":   receipt.DelegatorReward,
	}
