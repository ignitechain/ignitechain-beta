...
var (
	...
	// AllYantraProtocolChanges contains every protocol change (EIPs) introduced
	// and accepted by the Ethereum core developers into the Yantra consensus.
	//
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
	AllYantraProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, nil, &YantraConfig{Period: 0, Epoch: 30000}}
...
type ChainConfig struct {
	...
	Yantra *YantraConfig `json:"yantra,omitempty"`
}
...
// YantraConfig is the consensus engine configs for proof-of-authority based sealing.
...
// String implements the stringer interface, returning the consensus engine details.
func (c *YantraConfig) String() string {
	return "yantra"
}
